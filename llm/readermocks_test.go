...
// Source: github.com/kardolus/maps/llm (interfaces: FileReader)
...
func (m *MockFileReader) FileToBytes(arg0 string) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FileToBytes", arg0)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFileReaderMockRecorder) FileToBytes(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FileToBytes", reflect.TypeOf((*MockFileReader)(nil).FileToBytes), arg0)
}
